...
- the first click is always safe and reveals a number or opening surrounded 
by numbers
...
- if all the mines are flagged around a number you can press both mouse buttons 
to clear the adjacent squares
